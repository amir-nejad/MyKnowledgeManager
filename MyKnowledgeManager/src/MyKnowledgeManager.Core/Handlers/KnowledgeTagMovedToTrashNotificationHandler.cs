...
{
    /// <summary>
    /// This class is a handler for <see cref="TrashStateChanged{KnowledgeTag}"/> event.
    /// </summary>
    public class KnowledgeTagMovedToTrashNotificationHandler : INotificationHandler<TrashStateChanged<KnowledgeTag>>
    {
        private readonly IKnowledgeTagRelationService _knowledgeTagRelationService;

        public KnowledgeTagMovedToTrashNotificationHandler(IKnowledgeTagRelationService knowledgeTagRelationService)
        {
            _knowledgeTagRelationService = knowledgeTagRelationService;
        }

        public async Task Handle(TrashStateChanged<KnowledgeTag> notification, CancellationToken cancellationToken)
        {
